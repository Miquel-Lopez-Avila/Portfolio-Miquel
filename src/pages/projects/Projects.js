  ...
  return (
    <Wrapper showView={showView}>
      ...
      <ContainerProjects>
        <Block>
          <Anchor
            href="https://github.com/Miquel-Lopez-Avila/nodes-navigation-focus"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <ContainerText>
            <div>
              ...
              This is a JS library which{" "}
              <ColoredSpan>
                automates the focus moviment in the screen.
              </ColoredSpan>
              <br />
              The library uses the{" "}
              <ColoredSpan>react-hooks to manipulate the DOM</ColoredSpan> and
              recieve and return infomation about the state of the element.
            </div>
          </ContainerText>
        </Block>
        <Block reverse>
          <Anchor
            href="https://github.com/Miquel-Lopez-Avila/FlowTime"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <ContainerText>
            <div>
              ...
              <br />
              This is an extension to <ColoredSpan>manage time</ColoredSpan>,
              with the finallity of make rest during a determinate period of
              work.
            </div>
          </ContainerText>
        </Block>
        <Block>
          <Anchor
            href="https://github.com/Miquel-Lopez-Avila/Carendar-REACT"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <ContainerText>
            <div>
              ...
              <ColoredSpan>management functions.</ColoredSpan>
              <br />
              Such as requesting, modifying or deleting hairdresser
              appointments, inventory or stock management, customer management
              (personal information) and cashier control, mainly.
            </div>
          </ContainerText>
        </Block>
      </ContainerProjects>
